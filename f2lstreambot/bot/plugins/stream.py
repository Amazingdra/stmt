...
async def media_receive_handler(_, m: Message):
    ...
    await m.reply_text(
        ...
        quote=True,
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('playit link🤗', url=https://playit.playdisk.xyz/api?api=2b6a764deb2bac2525c7b7764e8793e15baa516a&url={sl})]])
    )
